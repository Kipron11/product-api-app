...
describe('ProductsPage', () => {
  ...
  it("fetches and displays products", async () => {
    const mockProducts:ProductModel[] = [
      { id: 1, name: "Product 1", price: 1.1, currency: "EUR", category: "TestFruit", description:"Test Description" },
      { id: 2, name: "Product 2", price: 1.1, currency: "TUBRIK", category: "Testingus", description:"Test disco ball"},
    ];
